...
lazy val docs = project
  ...
  .settings(
    ...
    Compile / paradoxProperties ++= Map(
      ...
      // Pekko
      "extref.pekko.base_url" -> "https://pekko.apache.org/docs/pekko/${PekkoCoreDependency.default.link}/%s",
      "scaladoc.base_url" -> "https://pekko.apache.org/api/pekko-persistence-jdbc/current/",
      "scaladoc.org.apache.pekko.base_url" -> "https://pekko.apache.org/api/pekko/${PekkoCoreDependency.default.link}/",
      "javadoc.org.apache.pekko.base_url" -> "https://pekko.apache.org/japi/pekko/${PekkoCoreDependency.default.link}/",
