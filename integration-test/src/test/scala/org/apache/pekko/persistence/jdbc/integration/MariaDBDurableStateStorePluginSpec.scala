...
class MariaDBDurableStateStorePluginSpec
    extends DurableStateStorePluginSpec(ConfigFactory.load("mariadb-shared-db-application.conf"), MariaDBProfile) {}

class MariaDBDurableStateStorePluginSchemaSpec
    extends DurableStateStoreSchemaPluginSpec(ConfigFactory.load("mariadb-application.conf"),
      MariaDBProfile) {}
